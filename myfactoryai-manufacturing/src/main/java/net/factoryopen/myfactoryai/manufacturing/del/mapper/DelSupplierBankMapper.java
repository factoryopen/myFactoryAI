 ...
 * @date 2024-07-04
 */
public interface DelSupplierBankMapper 
{
    /**
     * 查询供应商账号
     * 
     ...
     * @return 供应商账号集合
     */
    public List<DelSupplierBank> selectDelSupplierBankListBySupplierId(Long supplierId);
     ...
     * @return 供应商账号集合
     */
    public int deleteDelSupplierBankBySupplierId(Long supplierId);
}
