 ...
 * @date 2024-07-13
 */
public class ExeMlOperating extends BaseEntity
{
    ...
    private String routingSopUrl;

    private String routingVideoUrl;

    private String routingDrawingUrl;
    ...
    public String getRoutingSopUrl() {
        return routingSopUrl;
    }

    public void setRoutingSopUrl(String routingSopUrl) {
        this.routingSopUrl = routingSopUrl;
    }

    public String getRoutingVideoUrl() {
        return routingVideoUrl;
    }

    public void setRoutingVideoUrl(String routingVideoUrl) {
        this.routingVideoUrl = routingVideoUrl;
    }

    public String getRoutingDrawingUrl() {
        return routingDrawingUrl;
    }

    public void setRoutingDrawingUrl(String routingDrawingUrl) {
        this.routingDrawingUrl = routingDrawingUrl;
    }
