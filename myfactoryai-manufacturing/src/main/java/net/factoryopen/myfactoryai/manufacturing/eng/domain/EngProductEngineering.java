...
/**
 * 产品工艺管理对象 eng_material
 * 
 * @author jitfactory-generator
 * @date 2024-07-11
 */
public class EngProductEngineering extends BaseEntity
{
    ...
    public String toString() {
        return "EngMaterial{" +
                ...
                ", quantityScraped=" + quantityScraped +
                ...
                ", lineId=" + lineId +
                ", rateLoss=" + rateLoss +
                ", daysCycletime=" + daysCycletime +
                ", daysLeadtime=" + daysLeadtime +
                ", daysPosttime=" + daysPosttime +
                ", status=" + status +
                '}';
    }
}
