 ...
 * @date 2024-07-04
 */
public interface DelSupplierContactMapper 
{
    /**
     * 查询供应商人员
     * 
     ...
     * @return 供应商人员集合
     */
    public List<DelSupplierContact> selectDelSupplierContactListBySupplierId(Long supplierId);
     ...
     * @return 供应商人员集合
     */
    public int deleteDelSupplierContactBySupplierId(Long supplierId);
}
