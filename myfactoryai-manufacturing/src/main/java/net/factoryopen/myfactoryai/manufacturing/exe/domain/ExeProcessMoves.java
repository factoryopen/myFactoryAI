...
/**
 * 工序移转记录对象 exe_process_moves
 * 
 * @author jitfactory-generator
 * @date 2024-07-13
 */
public class ExeProcessMoves extends BaseEntity
{
    ...
    @Excel(name = "排配接收时间", width = 30, dateFormat = "yyyy-MM-dd")
    private Date receiveTimeScheduled;

    /** 排配转出时间 */
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    @Excel(name = "排配转出时间", width = 30, dateFormat = "yyyy-MM-dd")
