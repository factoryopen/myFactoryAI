...
<script>
import { listGasFoodieCategory, getGasFoodieCategory, delGasFoodieCategory, addGasFoodieCategory, updateGasFoodieCategory } from "@/api/ehs/gasFoodieCategory";

export default {
    name: "GasFoodieCategory",
    ...
    methods: {
      ...
      rowClassName({ row, rowIndex }) {
        ...
        getList() {
            this.loading = true;
        listGasFoodieCategory(this.queryParams).then(response => {
          this.gasFoodieCategoryList = response.rows;
        ...
        handleUpdate(row) {
            ...
            getGasFoodieCategory(id).then(response => {
        ...
        handleDelete(row) {
            ...
            this.$modal.confirm('确认删除名称为"' + namez + '"的数据项？').then(function() {
              return delGasFoodieCategory(ids);
            }).then(() => {
              this.getList();
        ...
        handleExport() {
            this.download('ehs/gasFoodieCategory/export', {
             ...this.queryParams
             }, `gasFoodieCategory_${new Date().getTime()}.xlsx`)
        },
            ...
            if(this.form.id==this.form.id){
              ...
              //TODO 上述两行代码须替代或删除
                ...
                if (this.form.id != null) {
                  updateGasFoodieCategory(this.form)
                  .then(response => {
                  ...
                  addGasFoodieCategory(this.form)
                  .then(response => {
                    this.$modal.msgSuccess(response.msg);
                    this.open = false;
                    this.getList();
