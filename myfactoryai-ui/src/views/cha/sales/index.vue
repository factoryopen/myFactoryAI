<template>
 ...
 :disabled="multiple"                     @click="handleDelete"
        ...
        <el-table v-loading="loading" border
            ...
            <el-table-column label="用户" align="center" prop="userId"  width="65">
            ...
            <el-table-column label="部门" align="left" prop="deptId" width="100">
                <template  slot-scope="scope">
...
<script>
import { listSales, getSales, delSales, addSales, updateSales } from "@/api/cha/sales";
...
/**主表外键UserId被选择后触发事件*/
        ...
        handleExport() {
            this.download('cha/sales/export', {
             ...this.queryParams
