          ...
          <el-table-column label="操作" fixed="right" align="center" class-name="small-padding fixed-width" width="180">
            <template slot-scope="scope">
              <el-button
                ...
                type="text"
                icon="el-icon-bell"
                @click="noticeEngineering(scope.row)"
      ...
      <el-dialog :title="title" class="dialogConfig" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="120px" :inline-message="true">
          ...
          <el-form-item prop="productName" class="marginBottom0" >
            ...
            <el-input class="inputWidth" v-model="form.productName" size="mini" disabled="true"/>
          </el-form-item>
          <el-form-item prop="productSpec" class="marginBottom0" >
            <span slot="label">
                <span class="fontSize12"><strong>产品规格</strong></span>
            </span>
            <el-input class="inputWidth" v-model="form.productSpec" size="mini" disabled="true"/>
          </el-form-item>
        ...
        <el-dialog :title="title" class="dialogConfig" :visible.sync="openchangeDelMps" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="ruleschangeDelMps" label-width="120px" :inline-message="true">
                ...
                <el-form-item prop="productId" class="marginBottom0">
                    ...
                    <el-select class="inputWidth" v-model="form.productId"  filterable placeholder="请选择产品编码" @change="onProductIdSelection" size="mini" disabled="true">
                        <el-option
                            v-for="(fkrow, index) in fkProductBasisList"
                            :key="index"
...
import { listMps, getMps, delMps, addMps, updateMps, noticeEngineering } from "@/api/del/mps";
