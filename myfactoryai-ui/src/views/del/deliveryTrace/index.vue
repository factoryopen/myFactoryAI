<template>
  <div class="app-container">
    ...
    <el-table ref="masterTable" v-loading="loading" border
      ...
      <el-table-column label="库存量" align="right" prop="quantityQualified" width="65"/>
      <el-table-column label="预约量" align="right" prop="quantityBooked" width="65"/>
      <el-table-column label="可用量" align="right" prop="quantityAvailable" width="65"/>
      ...
      <el-table-column label="欠备量" align="right" prop="quantityPrepareLack" width="65"/>
