<template>
    <div class="app-container">
        ...
        <el-table ref="masterTable" v-loading="loading" border
            ...
            <el-table-column type="selection" width="50" align="center" />
              ...
              <el-table-column label="状态" align="center" prop="status" width="65">
                ...
                <el-table-column label="订单项" align="center" prop="soItemId"  width="65">
                <template  slot-scope="scope">
      ...
      <el-dialog :title="title" class="dialogConfig" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="120px" :inline-message="true">
          <el-form-item  prop="billNo" class="marginBottom0">
            ...
            <el-input class="inputWidth" v-model="form.billNo" placeholder="请输入主计划号" size="mini" disabled="true"/>
          </el-form-item>
          <el-form-item  prop="mpsType" class="marginBottom0">
                    <span slot="label">
                        <span class="fontSize12"><strong>类型</strong></span>
                    </span>
            <el-select class="inputWidth" v-model="form.mpsType" placeholder="请选择类型" size="mini" >
              <el-option
                v-for="dict in dict.type.pln_mpsitem_type"
                :key="dict.value"
                :label="dict.label"
          ...
          <el-form-item prop="productId" class="marginBottom0">
            ...
            <el-select class="inputWidth" v-model="form.productId" filterable placeholder="请选择产品编码" @change="onProductIdSelection" size="mini">
              <el-option
          ...
          <el-form-item prop="productName" class="marginBottom0" >
            ...
            <el-select class="inputWidth" v-model="form.productName" size="mini" disabled="true">
              <el-option
                v-for="(fkrow, index) in fkDeliveryDealList"
                :key="index"
          ...
          <el-form-item prop="productSpec" class="marginBottom0" >
            ...
            <el-select class="inputWidth" v-model="form.productSpec" size="mini" disabled="true">
              <el-option
                v-for="(fkrow, index) in fkDeliveryDealList"
                :key="index"
          ...
          <el-form-item  prop="quantityPlanned" class="marginBottom0">
            ...
            <el-input class="inputWidth" v-model="form.quantityPlanned" placeholder="请输入计划数量" size="mini" />
          </el-form-item>
          ...
          <el-form-item prop="soId" class="marginBottom0" >
            ...
            <el-select class="inputWidth" v-model="form.soId" placeholder="请选择销售订单"
                       @change="onSoIdSelection"  size="mini" >
              <el-option
                v-for="(fkrow, index) in fkSoList"
                :key="index"
                :label="fkrow.billNo"
          ...
          <el-form-item prop="soItemId" class="marginBottom0" >
            ...
            <el-select class="inputWidth" v-model="form.soItemId" placeholder="请选择订单项"
                       @change="onSoItemIdSelection"  size="mini" >
              <el-option
      ...
      <!-- 创建master.openchangeDelMps对话框 -->
        <el-dialog :title="title" class="dialogConfig" :visible.sync="openchangeDelMps" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="ruleschangeDelMps" label-width="120px" :inline-message="true">
                <el-form-item  prop="billNo" class="marginBottom0">
                    <span slot="label">
                        <span class="fontSize12"><strong>主计划号</strong></span>
                    </span>
            ...
            <div slot="footer" class="dialog-footer">
               <el-button type="primary" @click="submitchangeDelMps">确 定</el-button>
               <el-button @click="cancelchangeDelMps">取 消</el-button>
            </div>
        </el-dialog>
...
import { listMps, getMps, delMps, addMps, updateMps } from "@/api/del/mps";
import { enable, changeDelMps,froze,unfroze,disable } from "@/api/del/mps";
...
import { listDeliveryDeal} from "@/api/del/deliveryDeal";
...
export default {
    ...
    methods: {
      ...
      cellStyle({row, column, rowIndex, columnIndex}) {
        ...
        else if (columnIndex==2 && row.status==16) {
      ...
      /**主表外键SoId被选择后触发事件*/
        ...
        onWoInfoProductIdSelection(fkId){
            this.fkProductBasisList.forEach(item=>{
                if(fkId === item.id){
                   this.formWoInfo.productId = item.id
                    this.formWoInfo.productSpec = item.materialSpec
                }
            });
        },
        /** 子表外键LineId被选择后触发事件 **/
