...
<script>
import { listDeliveryOrderFinishing, getDeliveryOrder, delDeliveryOrder, addDeliveryOrder, updateDeliveryOrder } from "@/api/del/deliveryOrder";
import {getNextBillno, updateBillSeq } from "@/api/del/deliveryOrder";
import { froze,unfroze,disable,finish,changeDelDeliveryOrder,delivery } from "@/api/del/deliveryOrder";
...
export default {
    ...
    methods: {
        ...
        getMasterList() {
          this.loading = true;
          listDeliveryOrderFinishing(this.queryParams).then(response => {
        ...
        getDeliveryOrderList() {
          listDeliveryOrderFinishing().then(res => {
       ...
       handleFinish(row) {
        ...
        handleExport() {
            this.download('del/deliveryOrder/exportFinishing', {
              ...this.queryParams
