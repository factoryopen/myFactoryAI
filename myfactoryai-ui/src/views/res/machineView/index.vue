<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="120px">
            <el-form-item prop="machineCode" class="marginBottom5">
                <span slot="label">
            ...
            <el-form-item prop="machineName" class="marginBottom5">
                <span slot="label">
            ...
            <el-form-item prop="typeId" class="marginBottom5" >
                    <span slot="label">
                        <span class="fontSize12"><strong>机型</strong></span>
                    </span>
              <el-select class="inputWidth" v-model="queryParams.typeId" placeholder="请选择机型" size="mini">
                <el-option
            ...
            <el-form-item prop="enableIiot" class="marginBottom5">
                <span slot="label">
                    <span class="fontSize12"><strong>数采否</strong></span>
                </span>
                <el-select v-model="queryParams.enableIiot" placeholder="请选择数采否" clearable size="mini" class="searchInput">
                    <el-option
            ...
            <el-form-item prop="ip" class="marginBottom5">
                <span slot="label">
            ...
            <el-form-item prop="processId" class="marginBottom5" >
              ...
              <el-select class="inputWidth" v-model="queryParams.processId" placeholder="请选择工序" size="mini">
                <el-option
                    ...
                    :key="index"
                    :label="fkrow.processName+' '+fkrow.processName"
                    :value="fkrow.id"
                    size="mini"
                ></el-option>
              </el-select>
        ...
        <el-table v-loading="loading" border
            ...
            <el-table-column label="IP" align="left" prop="ip" width="130"/>
            ...
            <el-table-column label="工序名" align="left" prop="processId"  width="120">
                <template  slot-scope="scope">
...
/**主表外键ProcessId被选择后触发事件*/
        ...
        handleSelectionChange(selection) {
            ...
            this.captions = selection.map(item => item.machineName)
        ...
        handleDelete(row) {
            ...
            const machineNamez = row.machineName || this.captions;
            this.$modal.confirm('确认删除机台名称为"' + machineNamez + '"的数据项？').then(function() {
        ...
        handleExport() {
            this.download('res/machine/export', {
             ...this.queryParams
