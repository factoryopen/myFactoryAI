<template>
    <div class="app-container">
        ...
        <el-table ref="masterTable" v-loading="loading" border
            ...
            <el-table-column label="计划数量" align="right" prop="quantityPlanned"  width="70"/>
            <el-table-column label="派工数量" align="right" prop="quantityAssigned"  width="70"/>
...
<script>
import { listWoAll, getWo, delWo, addWo, updateWo } from "@/api/pln/wo";
...
export default {
    ...
    methods: {
        ...
        getMasterList() {
          this.loading = true;
          listWoAll(this.queryParams).then(response => {
