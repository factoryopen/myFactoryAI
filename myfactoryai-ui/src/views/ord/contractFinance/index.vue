<template>
  <div class="app-container">
    ...
    <el-table ref="masterTable" v-loading="loading" border
      ...
      <el-table-column label="产品名称" align="left" prop="cproductName" width="130" show-overflow-tooltip/>
      <el-table-column label="图号" align="left" prop="cdrawNo" width="120" show-overflow-tooltip/>
      <el-table-column label="产品规格" align="left" prop="cproductSpec" width="110" show-overflow-tooltip/>
      <el-table-column label="客户料号" align="left" prop="ccustomerProductNo" width="110" show-overflow-tooltip/>
