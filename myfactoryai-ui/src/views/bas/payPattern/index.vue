<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading"
              ...
              :row-class-name="rowPayPatternIndex"
...
<script>
import { listPayPattern, getPayPattern, delPayPattern, addPayPattern, updatePayPattern } from "@/api/bas/payPattern";
...
export default {
    ...
    methods: {
      ...
      rowPayPatternIndex({ row, rowIndex }) {
        var className = ''
        if (row.priority == 1) {
      ...
      getList() {
        this.loading = true;
        listPayPattern(this.queryParams).then(response => {
          this.payPatternList = response.rows;
