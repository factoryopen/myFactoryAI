<template>
    <div class="app-container">
        ...
        <el-table ref="masterTable" height="300px" v-loading="loading" border
...
<script>
import { listStockRequest, getStockRequest, delStockRequest, addStockRequest, updateStockRequest } from "@/api/snc/stockRequest";
...
export default {
    ...
    methods: {
        ...
        getMasterList() {
          this.loading = true;
            listStockRequest(this.queryParams).then(response => {
                ...
                if(response.total) this.masterBillNo = response.rows[0].billNo;
                this.loadChildData();
                this.loading = false;
            });
        },
