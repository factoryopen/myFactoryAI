    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="120px">
            ...
            <el-form-item prop="houseId" class="marginBottom5" >
              ...
              <el-select class="inputWidth" v-model="queryParams.houseId" placeholder="请选择仓库" size="mini">
                <el-option
            ...
            <el-form-item prop="positionId" class="marginBottom5" >
              ...
              <el-select class="inputWidth" v-model="queryParams.positionId" placeholder="请选择储位" size="mini">
                <el-option
            ...
            <el-form-item prop="materialId" class="marginBottom5" >
              ...
              <el-select class="inputWidth" v-model="queryParams.materialId" placeholder="请选择物料编码" size="mini">
                <el-option
        ...
        <el-table v-loading="loading" border
            ...
            <el-table-column label="储位" align="left" prop="positionId"  width="120">
                <template  slot-scope="scope">
            ...
            <el-table-column label="图号" align="left" prop="drawNo" width="130"/>
