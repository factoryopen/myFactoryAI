...
<script>
import { listPoFinishing, finish, getPo, delPo, addPo, updatePo } from "@/api/sup/po";
...
export default {
    ...
    methods: {
        ...
        getMasterList() {
          this.loading = true;
          listPoFinishing(this.queryParams).then(response => {
