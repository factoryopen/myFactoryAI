<template>
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="120px">
            <el-form-item prop="userId" class="marginBottom5" >
                    <span slot="label">
                        <span class="fontSize12"><strong>用户</strong></span>
                    </span>
              <el-select class="inputWidth" v-model="queryParams.userId" placeholder="请选择用户" size="mini">
                <el-option
            ...
            <el-form-item prop="deptId" class="marginBottom5" >
              ...
              <el-select class="inputWidth" v-model="queryParams.deptId" placeholder="请选择部门" size="mini">
                <el-option
                    v-for="(fkrow, index) in fkUserList"
                    :key="index"
 ...
 :disabled="multiple"                     @click="handleExport"
        ...
        <el-table v-loading="loading" border
            ...
            <el-table-column label="用户" align="center" prop="userId"  width="100">
            ...
            <el-table-column label="部门" align="center" prop="deptId" width="100">
                <template  slot-scope="scope">
        ...
        <el-dialog :title="title" class="dialogConfig" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="120px" :inline-message="true">
                <el-form-item prop="userId" class="marginBottom0" >
                    <span slot="label"><span class="fontSize12"><strong>用户</strong></span></span>
                    <el-select class="inputWidth" v-model="form.userId" placeholder="请选择用户"
                               @change="onUserIdSelection"  size="mini" >
                      <el-option
                          v-for="(fkrow, index) in fkUserList"
                          :key="index"
                          :label="fkrow.nickName"
                ...
                <el-form-item prop="deptId" class="marginBottom0">
                    ...
                    <el-select class="inputWidth" v-model="form.deptId" placeholder="请选择部门" size="mini" disabled="true">
                      <el-option
...
<script>
import { listBuyers, getBuyers, delBuyers, addBuyers, updateBuyers } from "@/api/sup/buyers";
...
/**主表外键UserId被选择后触发事件*/
        ...
        getList() {
            this.loading = true;
        listBuyers(this.queryParams).then(response => {
          this.buyersList = response.rows;
        ...
        handleExport() {
            this.download('sup/buyers/export', {
             ...this.queryParams
